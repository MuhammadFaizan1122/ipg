    ...
    <div className='dark:bg-black'>
      ...
      <div className='w-[100%] bg-[#fff] overflow-hidden'>
        <div className='mt-0 text-[#ffcb04]'>
          ...
          <div className='mx-auto bg-[url("/IronPowerGymBanner.jpg")] bg-cover w-[100%] h-[88vh]  overflow-hidden flex justify-center items-center'>
            {/* <img src="/IronPowerGymBanner.jpg" alt="" className='w-[100%] px-4 rounded-2xl' /> */}
            <div className='grid grid-cols-4 sm:grid-cols-2'>
              <div className='shadow-xl h-40 mx-4 rounded-2xl bg-[lightGreen] flex justify-center items-center my-2 p-2'>
              ...
              <div className='shadow-xl h-40 mx-4 rounded-2xl bg-[pink]  flex justify-center items-center my-2 p-2'>
              ...
              <div className='shadow-xl h-40 mx-4 rounded-2xl bg-[#ffcb04]  flex justify-center items-center my-2 p-2'>
              ...
              <div className='shadow-xl h-40 mx-4 rounded-2xl bg-[#EDFF71]  flex justify-center items-center my-2 p-2'>
