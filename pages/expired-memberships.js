...
export default function ExpiredMemberships() {
    ...
    function unPaid(member) {
        ...
        let filter = member.filter(data => {
            ...
            return currentDay > day && currentMonth > month && currentYear == year || currentMonth == 0 && currentYear > year ? currentDay > day && month == 11 || month <= 10 : ""
        })
        return filter
    }
    // Delete member 
    ...
    return (
        <div className='w-[95%] mt-4 mx-auto'>
            ...
            <div className='bg-[#ffcb043b] py-4 rounded flex'>
                ...
                <div className='font-semibold truncate h-6 w-[10%] text-center sm:w-[29%]'>Number</div>
