                    ...
                    Admissions.admissions.map((item, index) => {
                        return (
                            <div className='border-b-[1px] flex' key={index}>
                                ...
                                <Image src="/profile.png" className='w-[40px] h-[40px]' alt=""/>
                                </div>
                                <div className='py-2 border-[1px] border-[transparent] truncate w-[20%] sm:w-[50%] sm:pl-2'>{item.name}</div>
                                ...
                                <div className='py-2 border-[1px] border-[transparent] truncate w-[10%] sm:w-[15%] text-center'><Edit /></div>
